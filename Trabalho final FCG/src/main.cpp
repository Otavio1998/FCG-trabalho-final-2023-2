...
float g_CameraDistance = 1.5f; // Distância da câmera para a origem
...
int main(int argc, char* argv[])
{
    ...
    ObjModel CATmodel("../../data/12222_Cat_v1_l3.obj","../../data/");
    ...
    ObjModel roommodel("../../data/Room.obj", "../../data/");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec4 camera_position_c  = glm::vec4(cat_position.x+x,cat_position.y+y,cat_position.z-z,1.0f); // Ponto "c", centro da câmera, depende da posição do gato para que ele seja o centro
        glm::vec4 camera_lookat_l    = glm::vec4(cat_position.x,cat_position.y+0.5f,cat_position.z,1.0f); // Ponto "l", para onde a câmera (look-at) estará sempre olhando, depende da posição do gato
